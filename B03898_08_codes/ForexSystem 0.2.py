...
class ForexSystem(oandapy.Streamer):
    ...
    def tick_event(self, time, symbol, bid, ask):
        ...
        if self.ticks>8:
             ...
             self.ATR(self.resampled_prices)
        ...
        self.print_status()
        print(self.resampled_prices.tail())
...
if __name__ == "__main__":
    key = "01a640ca1cfead40d91cfec1b8fc1093-bf320929f7698fd97cf0b1aa2f1531a5" 
